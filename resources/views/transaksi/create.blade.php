...
@section('content')
    <x-content :title="['name'=>'Transaksi','icon'=>'fas fa-cash-register']">
        <div class="card card-lightblue card-outline">
            ...
            <form action="{{ route('transaksi.store',['member'=>$member->id]) }}"
                method="POST" class="card-body border-top">
                @csrf
                <div class="row">
                    <div class="col">
                        <div class="form-group row">
                            <label for="" class="col">Tanggal</label>
                            <div class="col">
                                <x-input-transaksi 
                                name="tanggal"
                        ...
                        <div class="form-group row">
                            <label for="" class="col">Batas Waktu</label>
                            <div class="col">
                                <x-input-transaksi 
                                name="batas_waktu"
                                type="datetime-local"/>
                    ...
                    <div class="col">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col">
                                ...
                                name="total_bayar"
                                id="total_bayar"
                                :value="$total + ($total * 10 / 100)" disabled/>
                            </div>
                        </div>
                        <div class="form-group row">
